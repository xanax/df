package org.newdawn.slick.util.pathfinding.example;
...
public class PathTest extends JFrame {
	...
	public PathTest() {
		...
		try {
			tiles[GameMap.TREES] = ImageIO.read(getResource("tree.png"));
			tiles[GameMap.GRASS] = ImageIO.read(getResource("grass.png"));
			tiles[GameMap.WATER] = ImageIO.read(getResource("water.png"));
			tiles[GameMap.TANK] = ImageIO.read(getResource("tank.png"));
			tiles[GameMap.PLANE] = ImageIO.read(getResource("plane.png"));
			tiles[GameMap.BOAT] = ImageIO.read(getResource("boat.png"));
		} catch (IOException e) {
